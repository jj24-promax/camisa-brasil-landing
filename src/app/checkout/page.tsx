                    ...
                    return (
                      <button 
                        ...
                        className={cn(
                          ...
                          isSelected ? "border-gold/60 bg-gold/10 ring-1 ring-gold/40" : "border-white/5 bg-white/[0.02] hover:bg-white/[0.04]"
                        )}
                      >
            ...
            <div className="glass-dark overflow-hidden rounded-[2rem] p-6 md:p-8">
              ...
              <div className="mt-6 flex flex-col items-center gap-3">
                ...
                <div className="flex items-center gap-4 opacity-30 grayscale">
                  <Image src="/images/alpha-brasil-gold-logo.png" alt="Logo" width={30} height={20} className="object-contain" />
                  <QrCode size={18} />
                </div>
              </div>
            </div>
